...
/* Дизайн-чек от 07.09, замечание 18: «Тултипам нужно 2 режима ширины.
   ...
   Режим общий для Tooltip и Hint: в Figma это один компонент-сет «Tooltip &
   Hint», и ширина у них не может расходиться. До правки Tooltip был жёстко
   256, а Hint — жёстко 592, и выбрать между ними было нечем.

   `auto` — «динамический», то есть по содержимому. Верхняя граница у него
   всё же есть (592 — собственный максимум Hint из документации): без неё
   строка без переносов растянула бы пузырь на весь вьюпорт, а это уже не
   «динамическая ширина», а её отсутствие. */
export type TooltipWidth = "base" | "auto"
