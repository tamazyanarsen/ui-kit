...
const meta = {
  ...
  // a generic "Set object" JSON editor. `signatories`/`info`/`documents` are
  // left alone: arrays of plain structured data, already fine to edit as raw
  // JSON, same as other array-of-data props elsewhere in this kit.
  argTypes: {
