...
// Таблица, собранная композицией: разметку строк и ячеек пишет само место
// использования. Стенд по конфигу полей — рядом, в `table-demo.tsx`.
