      ...
      <AccordionPanel>
        ...
        <div className="mt-8 flex flex-col gap-2">
          ...
          <div className="max-w-md rounded-2xl border border-border p-4">
            <p className="text-p2-medium text-muted-foreground">Субсублимит</p>
            <div className="mt-1 mb-4 flex items-center justify-between rounded-lg border border-border px-3 py-2 text-p2-medium">
