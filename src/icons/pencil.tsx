...
export function Pencil({ size: _size, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}><path fill="currentColor" d="M10.4 2.4a1.4 1.4 0 0 1 1.98 0l1.22 1.22a1.4 1.4 0 0 1 0 1.98l-7.09 7.09a1.4 1.4 0 0 1-.66.37l-2.99.75a.6.6 0 0 1-.73-.73l.75-2.99a1.4 1.4 0 0 1 .37-.66zm1.15.85-7.08 7.08a.2.2 0 0 0-.05.09l-.5 2.01 2.01-.5a.2.2 0 0 0 .09-.05L13.1 4.8a.2.2 0 0 0 0-.28l-1.27-1.27a.2.2 0 0 0-.28 0"/></svg>
  )
}
