          ...
          <div className="flex flex-wrap gap-6">
            {SKINS.map((skin) => (
              <div key={skin} className="flex flex-col items-start gap-2">
                <BankCard skin={skin} />
                <span className="max-w-[332px] text-p3-medium text-muted-foreground">
                  {SKIN_LABELS[skin]}
                </span>
              </div>
            ))}
        ...
        <div className="mt-8 flex flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex flex-col items-start gap-2">
              <BankCard skin="mono" />
              <span className="text-p3-medium text-muted-foreground">Баланс открыт</span>
            </div>
            <div className="flex flex-col items-start gap-2">
              <BankCard skin="mono" showRequisites={false} />
              <span className="text-p3-medium text-muted-foreground">
                Скрыта ссылка «Показать реквизиты»
              </span>
            </div>
            <div className="flex flex-col items-start gap-2">
              <BankCard skin="mono" showBalance={false} />
              <span className="text-p3-medium text-muted-foreground">Баланс скрыт</span>
            </div>
            <div className="flex flex-col items-start gap-2">
              <BankCard skin="mono" showCardNumber={false} />
              <span className="text-p3-medium text-muted-foreground">Без номера карты</span>
            </div>
            <div className="flex flex-col items-start gap-2">
              <BankCard skin="mono" showPaymentSystem={false} showCardNumber={false} />
              <span className="text-p3-medium text-muted-foreground">Без платёжной системы</span>
            </div>
            <div className="flex flex-col items-start gap-2">
              <BankCard
                skin="mono"
              ...
              />
              <span className="text-p3-medium text-muted-foreground">Без информации</span>
            </div>
          </div>
        </div>
