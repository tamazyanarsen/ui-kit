            ...
            {Array.from({ length: 14 }, (_, i) => (
              ...
              >
                <div>
                  ...
                  <p className="text-p3-medium text-[#999999]">26 июля, 12:0{i % 10}</p>
                </div>
                <p className="text-p2-medium text-[#252628]">−{(i + 1) * 120} ₽</p>
              </div>
            ))}
          </div>
        </ModalBody>
  ...
  return (
    <Modal open={open} onOpenChange={setOpen}>
      ...
      <ModalContent size="m">
        ...
        <ModalBody>
          <label className="flex items-start gap-3 text-p2-medium text-[#252628]">
