...
/* Панель «Свойства компонента» компонент-сета `ELK / files` (вторая таблица
   ...
   ⚠️ `Show Count` в таблице есть, но НИ В ОДНОМ из шестнадцати символов сета
   счётчик не нарисован (проверены все четыре размера: 16029:58063, 58080,
   58723, 58865), и на канвасе 677:14056 нет ни одного узла с таким именем —
   ни в анатомии, ни в «Использовании в макете». Строка таблицы осталась от
   свойства, которого в макете нет; в замечании её поэтому и не было. */
const SIZE_LABELS = {
  "l-desktop": "L / Desktop",
  "s-desktop": "S / Desktop",
  "l-mobile": "L / Mobile",
...
const meta = {
  ...
  argTypes: {
    ...
    showEdit: toggleArgType(
      "Show Edit",
      "У размера L это иконка more (меню действий с файлом), у S — download. Так в макете, см. комментарий в file-item.tsx"
    ),
