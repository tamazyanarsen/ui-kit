        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-6">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-p3-medium text-muted-foreground">Default</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Thumbnail type="card" paymentSystem="mir" disabled />
              <span className="text-p3-medium text-muted-foreground">Disabled</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Thumbnail type="card" paymentSystem="mir" showDot />
              <span className="text-p3-medium text-muted-foreground">Count Dot</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Thumbnail type="card" paymentSystem="mir" count={3} />
              <span className="text-p3-medium text-muted-foreground">Count</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Thumbnail type="icon" />
              <span className="text-p3-medium text-muted-foreground">More</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4">
            {CARD_FORM_TYPES.map(({ type, label }) => (
              <div key={type} className="flex flex-col gap-2">
                ...
                <span className="text-p3-medium text-muted-foreground">{label}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col gap-2">
          ...
          <div className="flex items-center gap-3 rounded-xl bg-[#F8F8F8] p-4">
            ...
            <div className="flex flex-col">
              <span className="text-p2-medium text-[#252628]">
