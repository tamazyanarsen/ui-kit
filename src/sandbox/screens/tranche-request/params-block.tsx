    ...
    <SandboxBlock>
      <SandboxSection title="Параметры транша">
        ...
        <ItemInformationField
          ...
          value={money(limit)}
          // Дизайн-чек «Storybook 3», замечание 19: текст тултипа у (i) —
          // ровно «До 60% от цены договора подряда». Здесь стояло своё
          // объяснение механики лимита; в макете подсказка называет саму
          // долю.
          valueInfo="До 60% от цены договора подряда"
        />

        {/* Дизайн-чек «Storybook 3», замечание 18: «измени вид легенды у
            графика согласно макетам, а именно на вид Point» — маркер кружок 8,
            а не черта 16×4 (`Legend Element (ELK)`, `Type=Point`). */}
        <SandboxCompositionBar
          legendMarker="point"
          segments={[
